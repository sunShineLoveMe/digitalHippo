...
import { ArrowDownToLine, Check, CheckCircle, Leaf } from "lucide-react";
import Link from "next/link";

const perks = [
  {
    name: 'Instant Devliery',
    Icon: ArrowDownToLine,
    description: 'Get your assets deleivered instantly after purchase and download them right away'
  },
  {
    name: 'Guaranteed Quality',
    Icon: CheckCircle,
    description: 'Every asset on our platform is carefully reviewed and curated by our team of experts'
  },
  {
    name: 'For our Planet',
    Icon: Leaf,
    description: 'We plant a tree for every purchase made on our platform to help our planet'
  }
]
